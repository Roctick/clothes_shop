...
engine = create_async_engine(url='sqlite+aiosqlite:///db_accessories.sqlite3')# создвём БД
...
class Item(Base):
    ...
    category: Mapped[int] = mapped_column(ForeignKey('accessories_categories.id'))
